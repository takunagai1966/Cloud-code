...
- **【訂正】** シリーズ1の製作パートナーはマレーシアの会社であり、石巻工房は製作パートナーではなくデザイン・ものづくりの思想の**参考モデル**であることを明確化。以前 PARTNER_CANDIDATES.md 等で石巻工房を「製作パートナー候補」としていた記述を訂正し、石巻工房への打診メール案は送付しない参考扱いに変更。マレーシアの会社の詳細情報は確認中で、判明次第追記する。
